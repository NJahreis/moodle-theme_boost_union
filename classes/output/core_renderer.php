...
class core_renderer extends \theme_boost\output\core_renderer {
     ...
     * Doing this, it uses the same logic as Moodle 4.1dev already which introduced a Moodle core favicon setting,
    ...
    public function get_logo_url($maxwidth = null, $maxheight = 200) {
        ...
        if ($hasflavourlogo != null) {
            ...
            // If any flavour applies to this page.
            // TODO This function returns the whole flavour. We just need one attribute. Add a select parameter to the function.
            $flavour = theme_boost_union_get_flavour_which_applies();
            if ($flavour != null) {
