 ...
 *             based on code by bdecent gmbh <https://bdecent.de> in format_kickstart.
...
if ($action && $flavourid) {
    ...
    if ($action == 'up') {
        ...
        if ($prevflavour) {
            ...
            // TODO Reset cache as soon as the sorting order is cached in theme_boost_union_get_flavour_which_applies().
        }
...
$createbutton = $OUTPUT->box_start('text-center');
